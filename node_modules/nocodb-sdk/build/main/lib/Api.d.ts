 ...
 */
export declare enum WorkspaceRolesV3Type {
 ...
 */
export declare enum BaseRolesV3Type {
    Owner = "owner",
    Creator = "creator",
    Editor = "editor",
    Viewer = "viewer",
...
export interface FilterGroupV3Type {
    ...
    filters: (FilterV3Type | FilterGroupV3Type | (FilterV3Type & FilterGroupV3Type))[];
}
...
export interface AuditType {
     ...
     */
    op_type?: 'COMMENT' | 'DATA' | 'PROJECT' | 'VIRTUAL_RELATION' | 'RELATION' | 'TABLE_VIEW' | 'TABLE' | 'VIEW' | 'META' | 'WEBHOOKS' | 'AUTHENTICATION' | 'TABLE_COLUMN' | 'ORG_USER';
    /**
     * Operation Sub Type
     * @example UPDATE
     */
    op_sub_type?: 'UPDATE' | 'INSERT' | 'BULK_INSERT' | 'BULK_UPDATE' | 'BULK_DELETE' | 'LINK_RECORD' | 'UNLINK_RECORD' | 'DELETE' | 'CREATE' | 'RENAME' | 'IMPORT_FROM_ZIP' | 'EXPORT_TO_FS' | 'EXPORT_TO_ZIP' | 'SIGNIN' | 'SIGNUP' | 'PASSWORD_RESET' | 'PASSWORD_FORGOT' | 'PASSWORD_CHANGE' | 'EMAIL_VERIFICATION' | 'ROLES_MANAGEMENT' | 'INVITE' | 'RESEND_INVITE';
    /** Audit Status */
    status?: string;
    /**
...
export interface SourceType {
     ...
     * @example mysql2
     */
    type?: 'mysql' | 'mysql2' | 'oracledb' | 'pg' | 'snowflake' | 'sqlite3' | 'databricks';
}
/**
...
export interface ColumnType {
    ...
    /** Column Options */
    colOptions?: FormulaType | LinkToAnotherRecordType | LookupType | RollupType | SelectOptionsType | object | (FormulaType & LinkToAnotherRecordType & LookupType & RollupType & SelectOptionsType & object);
    /**
     * Column Name
     * @example title
     */
 ...
 */
export type ColumnReqType = (ButtonColumnReqType | FormulaColumnReqType | LinkToAnotherColumnReqType | LookupColumnReqType | NormalColumnRequestType | RollupColumnReqType | (ButtonColumnReqType & FormulaColumnReqType & LinkToAnotherColumnReqType & LookupColumnReqType & NormalColumnRequestType & RollupColumnReqType)) & {
    column_name?: string;
...
export interface FilterType {
    ...
    children?: FilterType[];
    /** Comparison Operator */
    comparison_op?: 'allof' | 'anyof' | 'blank' | 'btw' | 'checked' | 'empty' | 'eq' | 'ge' | 'gt' | 'gte' | 'in' | 'is' | 'isWithin' | 'isnot' | 'le' | 'like' | 'lt' | 'lte' | 'nallof' | 'nanyof' | 'nbtw' | 'neq' | 'nlike' | 'not' | 'notblank' | 'notchecked' | 'notempty' | 'notnull' | 'null' | null | ('allof' | 'anyof' | 'blank' | 'btw' | 'checked' | 'empty' | 'eq' | 'ge' | 'gt' | 'gte' | 'in' | 'is' | 'isWithin' | 'isnot' | 'le' | 'like' | 'lt' | 'lte' | 'nallof' | 'nanyof' | 'nbtw' | 'neq' | 'nlike' | 'not' | 'notblank' | 'notchecked' | 'notempty' | 'notnull' | ('null' & null));
    /** Comparison Sub-Operator */
    comparison_sub_op?: 'daysAgo' | 'daysFromNow' | 'exactDate' | 'nextMonth' | 'nextNumberOfDays' | 'nextWeek' | 'nextYear' | 'oneMonthAgo' | 'oneMonthFromNow' | 'oneWeekAgo' | 'oneWeekFromNow' | 'pastMonth' | 'pastNumberOfDays' | 'pastWeek' | 'pastYear' | 'today' | 'tomorrow' | 'yesterday' | null | ('daysAgo' | 'daysFromNow' | 'exactDate' | 'nextMonth' | 'nextNumberOfDays' | 'nextWeek' | 'nextYear' | 'oneMonthAgo' | 'oneMonthFromNow' | 'oneWeekAgo' | 'oneWeekFromNow' | 'pastMonth' | 'pastNumberOfDays' | 'pastWeek' | 'pastYear' | 'today' | 'tomorrow' | ('yesterday' & null));
...
export interface HookType {
     ...
     * @example insert
     */
    operation?: 'insert' | 'update' | 'delete' | 'bulkInsert' | 'bulkUpdate' | 'bulkDelete' | 'trigger';
    /**
     * Retry Count
     * @example 10
     */
...
export interface ProjectUserReqType {
    ...
    email: string;
    /** Base User Role */
    roles: 'no-access' | 'commenter' | 'editor' | 'guest' | 'owner' | 'viewer' | 'creator';
}
/**
 * Model for Base User Request
 */
...
export interface RollupColumnReqType {
    ...
    title?: string;
    /** Rollup Function */
    rollup_function?: 'avg' | 'avgDistinct' | 'count' | 'countDistinct' | 'max' | 'min' | 'sum' | 'sumDistinct';
    /** UI DataType */
    uidt?: 'Rollup';
}
/**
 ...
 */
export type StringOrNullOrBooleanOrNumberType = string | null | boolean | number;
/**
 * Model for IdOrNull
 */
...
export interface ViewType {
    ...
    view?: FormType | GalleryType | GridType | KanbanType | MapType | CalendarType | (FormType & GalleryType & GridType & KanbanType & MapType & CalendarType);
...
export declare enum ButtonActionsType {
    Webhook = "webhook",
    Url = "url",
    Ai = "ai",
    Script = "script"
...
export declare class HttpClient<SecurityDataType = unknown> {
    ...
    request: <T = any, _E = any>({ secure, path, type, query, format, wrapped, body, ...params }: FullRequestParams) => Promise<T>;
}
/**
 * @title nocodb
 * @version 1.0
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    userProfile: {
         ...
         */
        update: (data: UserType, params?: RequestParams) => Promise<UserType>;
    };
    auth: {
        /**
     ...
     */
        signup: (data: SignUpReqType, params?: RequestParams) => Promise<{
            /**
             * The signed JWT token for information exchange
             * @example eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gzwp_svZlbA5PV_eawYV-9UFjZVjniy-tCDce16xrkI
             */
     ...
     */
        signout: (params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example Signed out successfully
             */
     ...
     */
        signin: (data: SignInReqType, params?: RequestParams) => Promise<{
            /**
             * The signed JWT token for information exchange
             * @example eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gzwp_svZlbA5PV_eawYV-9UFjZVjniy-tCDce16xrkI
             */
     ...
     */
        me: (query?: {
            ...
            base_id?: IdType;
        }, params?: RequestParams) => Promise<UserInfoType>;
        /**
     ...
     */
        passwordForgot: (data: PasswordForgotReqType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example Please check your email to reset the password
             */
     ...
     */
        passwordChange: (data: PasswordChangeReqType, params?: RequestParams) => Promise<{
            /** Success Message */
            msg?: string;
        }>;
        /**
     ...
     */
        passwordResetTokenValidate: (token: string, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example Token has been validated successfully
             */
     ...
     */
        emailValidate: (token: string, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example Email has been verified successfully
             */
     ...
     */
        passwordReset: (token: string, data: PasswordResetReqType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example Password has been reset successfully
             */
     ...
     */
        tokenRefresh: (params?: RequestParams) => Promise<{
            /**
             * New JWT auth token for user
             * @example 96751db2d53fb834382b682268874a2ea9ee610e4d904e688d1513f11d3c30d62d36d9e05dec0d63
             */
     ...
     */
        baseUserList: (baseId: IdType, params?: RequestParams) => Promise<{
            users?: {
                list: UserType[];
                /** Model for Paginated */
                pageInfo: PaginatedType;
     ...
     */
        baseUserAdd: (baseId: IdType, data: ProjectUserReqType, params?: RequestParams) => Promise<{
            /**
             * Success Message for inviting single email
             * @example The user has been invited successfully
             */
     ...
     */
        baseUserUpdate: (baseId: IdType, userId: IdType, data: ProjectUserReqType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The user has been updated successfully
             */
     ...
     */
        baseUserRemove: (baseId: IdType, userId: IdType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The user has been updated successfully
             */
     ...
     */
        baseUserResendInvite: (baseId: IdType, userId: IdType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The invitation has been sent to the user
             */
     ...
     */
        list: (params?: RequestParams) => Promise<ApiTokenListType>;
        /**
     ...
     */
        create: (data: ApiTokenReqType, params?: RequestParams) => Promise<ApiTokenType>;
        /**
     ...
     */
        delete: (tokenId: string, params?: RequestParams) => Promise<number>;
    };
    orgLicense: {
        /**
     ...
     */
        get: (params?: RequestParams) => Promise<{
            /** Application license key */
            key?: string;
        }>;
        /**
     ...
     */
        set: (data: LicenseReqType, params?: RequestParams) => Promise<{
            /** @example The license key has been saved */
            msg?: string;
        }>;
    };
     ...
     */
        list: (params?: RequestParams) => Promise<UserListType>;
        /**
     ...
     */
        add: (data: OrgUserReqType, params?: RequestParams) => Promise<{
            /** Invite Token */
            invite_token?: string;
            /**
             * User email
     ...
     */
        update: (userId: IdType, data: OrgUserReqType, params?: RequestParams) => Promise<{
            /** @example The user has been updated successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        delete: (userId: IdType, params?: RequestParams) => Promise<{
            /**
             * Sucess Message
             * @example The user has been deleted successfully
             */
         ...
         */
        getByUsername: (username: string, params?: RequestParams) => Promise<UserType>;
        /**
     ...
     */
        resendInvite: (userId: IdType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The invitation has been sent to the target user
             */
         ...
         */
        profileCreate: (userId: string, data: UserType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        profileGet: (userId: string, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        profileUpdate: (userId: string, data: UserType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        followerCreate: (userId: string, data: FollowerType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        followerList: (userId: string, data: FollowerType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        followerDelete: (userId: string, data: FollowerType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        followingList: (userId: string, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        isFollowing: (userId: string, followerId: string, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        generatePasswordResetToken: (userId: IdType, params?: RequestParams) => Promise<{
            /** Password Reset Token for the user */
            reset_password_token?: string;
            /** Password Reset URL for the user */
            reset_password_url?: string;
     ...
     */
        metaGet: (baseId: IdType, params?: RequestParams) => Promise<{
            /**
             * Node version
             * @example v12.16.1
             */
     ...
     */
        modelVisibilityList: (baseId: IdType, query?: {
            includeM2M?: boolean;
     ...
     */
        modelVisibilitySet: (baseId: IdType, data: VisibilityRuleReqType, params?: RequestParams) => Promise<{
            /** @example UI ACL has been created successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        list: (params?: RequestParams) => Promise<ProjectListType>;
        /**
     ...
     */
        sourceDuplicate: (baseId: IdType, data: {
            options?: {
                excludeData?: boolean;
            ...
            base?: object;
        }, sourceId?: IdType, params?: RequestParams) => Promise<{
            name?: string;
            id?: string;
            base_id?: string;
        }>;
     ...
     */
        read: (baseId: IdType, params?: RequestParams) => Promise<BaseType>;
        /**
     ...
     */
        delete: (baseId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        update: (baseId: IdType, data: ProjectUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
         * No description
         *
         * @tags Base
         ...
         * @response `200` `void` OK
         */
        userMetaUpdate: (baseId: string, data: ProjectUserMetaReqType, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        sharedBaseGet: (baseId: IdType, params?: RequestParams) => Promise<{
            /**
             * @format uuid
             * @example a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11
             */
     ...
     */
        sharedBaseDisable: (baseId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        sharedBaseCreate: (baseId: IdType, data: SharedBaseReqType, params?: RequestParams) => Promise<{
            /** Model for StringOrNull */
            uuid?: StringOrNullType;
            /** Model for StringOrNull */
            roles?: StringOrNullType;
     ...
     */
        sharedBaseUpdate: (baseId: IdType, data: SharedBaseReqType & {
            /** Custom url path */
     ...
     */
        cost: (baseId: IdType, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        duplicateShared: (workspaceId: IdType, sharedBaseId: any, data: {
            options?: {
                excludeData?: boolean;
                excludeViews?: boolean;
            };
     ...
     */
        metaDiffSync: (baseId: IdType, params?: RequestParams) => Promise<{
            /** @example The meta has been synchronized successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        metaDiffGet: (baseId: IdType, params?: RequestParams) => Promise<{
            /**
             * Table Name
             * @example Table 1
             */
     ...
     */
        hasEmptyOrNullFilters: (baseId: IdType, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        read: (baseId: IdType, sourceId: string, params?: RequestParams) => Promise<SourceType>;
        /**
     ...
     */
        delete: (baseId: IdType, sourceId: string, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        update: (baseId: IdType, sourceId: string, data: object, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        list: (baseId: IdType, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        create: (baseId: IdType, data: SourceType & {
            external?: boolean;
        }, params?: RequestParams) => Promise<SourceType>;
        /**
         * No description
         *
         * @tags Source
         ...
         * @response `200` `SourceType` OK
         */
        shareErd: (baseId: string, sourceId: string, params?: RequestParams) => Promise<SourceType>;
        /**
         * No description
         *
         * @tags Source
         ...
         * @response `200` `void` OK
         */
        disableShareErd: (baseId: string, sourceId: string, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        tableList: (baseId: IdType, sourceId: string, query?: {
            page?: number;
            pageSize?: number;
            sort?: string;
            includeM2M?: boolean;
        }, params?: RequestParams) => Promise<TableListType>;
        /**
     ...
     */
        tableCreate: (baseId: IdType, sourceId: string, data: TableReqType, params?: RequestParams) => Promise<TableType>;
        /**
     ...
     */
        metaDiffSync: (baseId: IdType, sourceId: string, params?: RequestParams) => Promise<{
            /** @example The source meta has been synchronized successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        metaDiffGet: (baseId: IdType, sourceId: string, params?: RequestParams) => Promise<{
            /**
             * Table Name
             * @example Table 1
             */
     ...
     */
        create: (baseId: IdType, data: TableReqType, params?: RequestParams) => Promise<TableType>;
        /**
     ...
     */
        read: (tableId: IdType, params?: RequestParams) => Promise<TableType>;
        /**
     ...
     */
        delete: (tableId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        duplicate: (baseId: IdType, tableId: IdType, data: {
            options?: {
                excludeData?: boolean;
                excludeViews?: boolean;
                excludeHooks?: boolean;
     ...
     */
        duplicateColumn: (baseId: IdType, columnId: IdType, data: {
            options?: {
                excludeData?: boolean;
            };
            extra?: object;
     ...
     */
        tableRead: (linkColumnId: IdType, tableId: IdType, params?: RequestParams) => Promise<TableType>;
    };
    dbTableColumn: {
        /**
     ...
     */
        create: (tableId: IdType, data: ColumnReqType, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        update: (columnId: string, data: ColumnReqType, params?: RequestParams) => Promise<ColumnType>;
        /**
     ...
     */
        delete: (columnId: string, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        get: (columnId: string, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        primaryColumnSet: (columnId: string, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        hash: (tableId: IdType, params?: RequestParams) => Promise<{
            /** Columns hash */
            hash?: string;
        }>;
        /**
     ...
     */
        list: (tableId: IdType, params?: RequestParams) => Promise<ViewListType>;
        /**
     ...
     */
        update: (viewId: IdType, data: ViewUpdateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        delete: (viewId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        showAllColumn: (viewId: IdType, query?: {
            ignoreIds?: any[];
        }, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        hideAllColumn: (viewId: IdType, query?: {
            ignoreIds?: any[];
        }, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        gridCreate: (tableId: IdType, data: ViewCreateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        formCreate: (tableId: IdType, data: ViewCreateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        formUpdate: (formViewId: IdType, data: FormUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        formRead: (formViewId: IdType, params?: RequestParams) => Promise<FormType>;
        /**
     ...
     */
        formColumnUpdate: (formViewColumnId: IdType, data: FormColumnReqType, params?: RequestParams) => Promise<FormColumnReqType>;
        /**
     ...
     */
        gridUpdate: (viewId: string, data: GridUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        gridColumnsList: (gridId: string, params?: RequestParams) => Promise<GridColumnType[]>;
        /**
     ...
     */
        gridColumnUpdate: (columnId: IdType, data: GridColumnReqType, params?: RequestParams) => Promise<number>;
        /**
     * No description
     *
     * @tags DB View
     ...
     */
        galleryCreate: (tableId: IdType, data: ViewCreateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        galleryUpdate: (galleryViewId: string, data: GalleryUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        galleryRead: (galleryViewId: string, params?: RequestParams) => Promise<GalleryType>;
        /**
     ...
     */
        kanbanCreate: (tableId: IdType, data: ViewCreateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        kanbanUpdate: (kanbanViewId: string, data: KanbanUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        kanbanRead: (kanbanViewId: string, params?: RequestParams) => Promise<KanbanType>;
        /**
     ...
     */
        mapCreate: (tableId: IdType, data: ViewCreateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        mapUpdate: (mapViewId: string, data: MapUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        mapRead: (mapViewId: string, params?: RequestParams) => Promise<MapType>;
        /**
     ...
     */
        calendarCreate: (tableId: IdType, data: ViewCreateReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        calendarUpdate: (calendarViewId: string, data: CalendarUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        calendarRead: (calendarViewId: string, params?: RequestParams) => Promise<CalendarType>;
    };
    dbViewShare: {
        /**
     ...
     */
        list: (tableId: IdType, params?: RequestParams) => Promise<SharedViewListType>;
        /**
     ...
     */
        create: (viewId: string, params?: RequestParams) => Promise<SharedViewReqType>;
        /**
     ...
     */
        update: (viewId: string, data: SharedViewReqType & {
            /** Custom url path */
            custom_url_path?: StringOrNullType;
        }, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        delete: (viewId: string, params?: RequestParams) => Promise<boolean>;
    };
    dbViewColumn: {
        /**
     ...
     */
        list: (viewId: string, params?: RequestParams) => Promise<ColumnListType>;
        /**
     ...
     */
        create: (viewId: string, data: ViewColumnReqType, params?: RequestParams) => Promise<ColumnType>;
        /**
     ...
     */
        update: (viewId: IdType, columnId: IdType, data: ViewColumnUpdateReqType, params?: RequestParams) => Promise<number>;
    };
    dbTableSort: {
        /**
     ...
     */
        list: (viewId: string, params?: RequestParams) => Promise<SortListType>;
        /**
     ...
     */
        create: (viewId: string, data: SortReqType & {
            /**
             * Push the sort to the top of the list
             * @example true
             */
            push_to_top?: boolean;
        }, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        get: (sortId: string, params?: RequestParams) => Promise<SortType>;
        /**
     ...
     */
        update: (sortId: string, data: SortReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        delete: (sortId: string, params?: RequestParams) => Promise<boolean>;
    };
    dbTableFilter: {
        /**
     ...
     */
        read: (viewId: string, query?: {
            includeAllFilters?: boolean;
        }, params?: RequestParams) => Promise<FilterListType>;
        /**
     ...
     */
        create: (viewId: string, data: FilterReqType, params?: RequestParams) => Promise<FilterType>;
        /**
     ...
     */
        get: (filterId: IdType, params?: RequestParams) => Promise<FilterType>;
        /**
     ...
     */
        update: (filterId: IdType, data: FilterReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        delete: (filterId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        childrenRead: (filterGroupId: IdType, params?: RequestParams) => Promise<FilterListType>;
    };
     ...
     */
        read: (hookId: IdType, params?: RequestParams) => Promise<FilterListType>;
        /**
     ...
     */
        create: (hookId: IdType, data: FilterReqType, params?: RequestParams) => Promise<FilterType>;
    };
    dbTableWebhookLogs: {
        /**
     ...
     */
        list: (hookId: IdType, query?: {
            /** @min 1 */
            limit?: number;
            /** @min 0 */
            offset?: number;
        }, params?: RequestParams) => Promise<HookLogListType>;
    };
    dbTableRow: {
        /**
     ...
     */
        list: (orgs: string, baseName: string, tableName: string, query?: {
     ...
     */
        create: (orgs: string, baseName: string, tableName: string, data: object, query?: {
            before?: string;
            undo?: boolean;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        findOne: (orgs: string, baseName: string, tableName: string, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
        }, params?: RequestParams) => Promise<object>;
        /**
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        groupBy: (orgs: string, baseName: string, tableName: string, query?: {
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        groupByCount: (orgs: string, baseName: string, tableName: string, query?: {
            /** Column name of the column you want to group by, eg. `column_name=column1` */
            column_name?: string;
            sort?: any[];
            where?: string;
     ...
     */
        groupedDataList: (orgs: string, baseName: string, tableName: string, columnId: IdType, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
     ...
     */
        read: (orgs: string, baseName: string, tableName: string, rowId: any, query?: {
     ...
     */
        update: (orgs: string, baseName: string, tableName: string, rowId: any, data: object, query?: {
            /** To get Hidden Columns */
            getHiddenColumn?: boolean;
        }, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        delete: (orgs: string, baseName: string, tableName: string, rowId: any, query?: {
            /** To get Hidden Columns */
            getHiddenColumn?: boolean;
        }, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        exist: (orgs: string, baseName: string, tableName: string, rowId: any, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        bulkUpsert: (orgs: string, baseName: string, tableName: string, data: object[], params?: RequestParams) => Promise<any[]>;
        /**
     ...
     */
        bulkCreate: (orgs: string, baseName: string, tableName: string, data: object[], query?: {
            undo?: string;
        }, params?: RequestParams) => Promise<{
            id?: string;
        }[]>;
     ...
     */
        bulkUpdate: (orgs: string, baseName: string, tableName: string, data: object[], params?: RequestParams) => Promise<number[]>;
        /**
     ...
     */
        bulkDelete: (orgs: string, baseName: string, tableName: string, data: object[], params?: RequestParams) => Promise<number[]>;
        /**
     ...
     */
        bulkUpdateAll: (orgs: string, baseName: string, tableName: string, data: object, query?: {
            where?: string;
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        bulkDeleteAll: (orgs: string, baseName: string, tableName: string, query?: {
            where?: string;
            viewId?: string;
        }, params?: RequestParams) => Promise<object[]>;
        /**
     ...
     */
        nestedList: (orgs: string, baseName: string, tableName: string, rowId: any, relationType: "mm" | "hm" | "bt" | "oo", columnName: string, query?: {
            /** @min 1 */
            limit?: number;
            /** @min 0 */
            offset?: number;
     ...
     */
        nestedAdd: (orgs: string, baseName: string, tableName: string, rowId: any, relationType: "mm" | "hm" | "bt" | "oo", columnName: string, refRowId: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        nestedRemove: (orgs: string, baseName: string, tableName: string, rowId: any, relationType: "mm" | "hm" | "bt" | "oo", columnName: string, refRowId: string, params?: RequestParams) => Promise<{
            /** @example The relation data has been deleted successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        nestedChildrenExcludedList: (orgs: string, baseName: string, tableName: string, rowId: any, relationType: "mm" | "hm" | "bt" | "oo", columnName: string, query?: {
            /** @min 1 */
            limit?: number;
            /** @min 0 */
            offset?: number;
     ...
     */
        groupedDataList: (orgs: IdType, baseName: string, tableName: string, viewName: string, columnId: IdType, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
            /** Query params for nested data */
     ...
     */
        list: (orgs: string, baseName: string, tableName: string, viewName: string, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
            /** Query params for nested data */
     ...
     */
        create: (orgs: string, baseName: string, tableName: string, viewName: string, data: object, query?: {
            before?: string;
            undo?: string;
        }, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        findOne: (orgs: string, baseName: string, tableName: string, viewName: string, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
            /** Query params for nested data */
     ...
     */
        groupBy: (orgs: string, baseName: string, tableName: string, viewName: string, query?: {
            /** Column name of the column you want to group by, eg. `column_name=column1` */
            column_name?: string;
            sort?: any[];
            where?: string;
     ...
     */
        groupByCount: (orgs: string, baseName: string, tableName: string, viewName: string, query?: {
            /** Column name of the column you want to group by, eg. `column_name=column1` */
            column_name?: string;
            sort?: any[];
            where?: string;
     ...
     */
        count: (orgs: string, baseName: string, tableName: string, viewName: string, query?: {
            where?: string;
            /** Query params for nested data */
            nested?: any;
        }, params?: RequestParams) => Promise<{
     ...
     */
        read: (orgs: string, baseName: string, tableName: string, viewName: string, rowId: any, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        update: (orgs: string, baseName: string, tableName: string, viewName: string, rowId: any, data: object, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        delete: (orgs: string, baseName: string, tableName: string, viewName: string, rowId: any, params?: RequestParams) => Promise<number>;
        /**
     * @description Check row with provided primary key exists or not
     *
     * @tags DB View Row
     ...
     */
        exist: (orgs: string, baseName: string, tableName: string, viewName: string, rowId: any, params?: RequestParams) => Promise<number>;
    };
    dbCalendarViewRow: {
        /**
         ...
         */
        publicDataCalendarRowList: (sharedViewUuid: string, query: {
            from_date: string;
            to_date: string;
            prev_date: string;
            next_date: string;
    ...
    api: {
         ...
         */
        responsesApi: (orgs: string, baseName: string, tableName: string, viewName: string, params?: RequestParams) => Promise<any>;
        /**
         * No description
         *
         * @name ResponsesApi2
         ...
         * @duplicate
         */
        responsesApi2: (sharedViewUuid: string, params?: RequestParams) => Promise<any>;
    };
     ...
     */
        dbCalendarViewRowCount: (orgs: string, baseName: string, tableName: string, viewName: string, query: {
            from_date: string;
            to_date: string;
            prev_date: string;
            next_date: string;
     ...
     */
        dataCalendarRowCount: (sharedViewUuid: string, query: {
            from_date: string;
            prev_date: string;
            next_date: string;
            to_date: string;
     ...
     */
        dbViewRowCount: (sharedViewUuid: string, query?: {
            where?: string;
            /** Query params for nested data */
            nested?: any;
        }, params?: RequestParams) => Promise<{
     ...
     */
        dataTableBulkDataList: (sharedViewUuid: string, data: object[], query?: {
            /** Extra filtering */
            where?: string;
        }, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        dataTableBulkGroup: (sharedViewUuid: string, data: object[], query?: {
            /** Extra filtering */
            where?: string;
        }, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        dataTableAggregate: (sharedViewUuid: string, query?: {
            /** Extra filtering */
            where?: string;
            /** Used for multiple filter queries */
            filterArrJson?: string;
     ...
     */
        dataAttachmentDownload: (sharedViewUuid: string, columnId: IdType, rowId: any, query?: {
     ...
     */
        groupedDataList: (sharedViewUuid: string, columnId: IdType, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        dataList: (sharedViewUuid: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
            ...
            /** Comma separated list of pks */
            pks?: string;
        }, params?: RequestParams) => Promise<SharedViewListType>;
        /**
     ...
     */
        dataCreate: (sharedViewUuid: string, data: any, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        dataGroupBy: (sharedViewUuid: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        dataGroupByCount: (sharedViewUuid: string, query?: {
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
            /** Extra filtering */
            where?: string;
     ...
     */
        dataNestedList: (sharedViewUuid: string, rowId: any, relationType: "mm" | "hm" | "bt" | "oo", columnName: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        dataRelationList: (sharedViewUuid: string, columnName: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        sharedBaseGet: (sharedBaseUuid: string, params?: RequestParams) => Promise<{
            /** Base ID */
            base_id?: string;
        }>;
        /**
     ...
     */
        sharedViewMetaGet: (sharedViewUuid: string, params?: RequestParams) => Promise<ViewType & {
            relatedMetas?: any;
            client?: string;
            source_id?: string;
            columns?: (GridColumnType | FormColumnType | GalleryColumnType | (GridColumnType & FormColumnType & GalleryColumnType)) & ColumnType;
         ...
         */
        sharedErdMetaGet: (sharedErdUuid: string, params?: RequestParams) => Promise<any>;
        /**
         ...
         */
        exportData: (publicDataUuid: IdType, exportAs: "csv", data: object, params?: RequestParams) => Promise<any>;
    };
    dbDataTableBulkList: {
        /**
     ...
     */
        dbDataTableBulkList: (tableId: string, query: {
            /** View ID is required */
            viewId: string;
            /** Extra filtering */
            where?: string;
        }, data: object[], params?: RequestParams) => Promise<object>;
    };
     ...
     */
        dbDataTableBulkGroupList: (tableId: string, query: {
            /** View ID is required */
            viewId: string;
        }, data: object[], params?: RequestParams) => Promise<object>;
    };
     ...
     */
        commentRow: (data: CommentReqType, params?: RequestParams) => Promise<CommentType>;
        /**
         ...
         * @response `200` `number` OK
         */
        commentUpdate: (commentId: string, data: CommentUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
         ...
         * @response `200` `number` OK
         */
        commentDelete: (commentId: string, data: any, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        auditRowUpdate: (rowId: any, data: AuditRowUpdateReqType, params?: RequestParams) => Promise<AuditType>;
        /**
     ...
     */
        appInfo: (params?: RequestParams) => Promise<{
            authType?: string;
            baseHasAdmin?: boolean;
            firstUser?: boolean;
            type?: string;
         ...
         */
        errorReport: (data: any, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        axiosRequestMake: (data: object, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        appVersion: (params?: RequestParams) => Promise<{
            /**
             * Current NocoDB Version
             * @example 0.104.0
             */
     ...
     */
        appHealth: (params?: RequestParams) => Promise<{
            /** @example OK */
            message?: string;
            /** @example 1678702175755 */
            timestamp?: string;
     ...
     */
        cloudFeatures: (params?: RequestParams) => Promise<{
            Id?: number;
            Title?: string;
            Highlight?: boolean;
            'Coming Soon'?: boolean;
     ...
     */
        aggregatedMetaInfo: (params?: RequestParams) => Promise<{
            baseCount?: number;
            bases?: {
                tableCount?: {
                    /** Table Count */
         ...
         */
        cacheGet: (params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        cacheDelete: (params?: RequestParams) => Promise<boolean>;
        /**
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        commandPalette: (data: any, params?: RequestParams) => Promise<any>;
    };
    dbTableWebhook: {
        /**
     ...
     */
        list: (tableId: IdType, params?: RequestParams) => Promise<HookListType>;
        /**
     ...
     */
        create: (tableId: IdType, data: HookReqType, params?: RequestParams) => Promise<HookType>;
        /**
     ...
     */
        test: (tableId: IdType, data: HookTestReqType, params?: RequestParams) => Promise<{
            /** @example The hook has been tested successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        samplePayloadGet: (tableId: IdType, operation: "insert" | "update" | "delete" | "bulkInsert" | "bulkUpdate" | "bulkDelete", version: "v1" | "v2", params?: RequestParams) => Promise<{
            /** Sample Payload Data */
            data?: object;
        }>;
        /**
     ...
     */
        update: (hookId: string, data: HookType, params?: RequestParams) => Promise<HookType>;
        /**
     ...
     */
        delete: (hookId: string, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        trigger: (hookId: IdType, rowId: IdType, params?: RequestParams) => Promise<void>;
    };
    plugin: {
        /**
     ...
     */
        webhookList: (params?: RequestParams) => Promise<{
            list?: PluginType[];
            /** Model for Paginated */
            pageInfo?: PaginatedType;
        }>;
     ...
     */
        status: (pluginId: string, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        test: (data: PluginTestReqType, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        update: (pluginId: string, data: PluginReqType, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        read: (pluginId: string, params?: RequestParams) => Promise<PluginType>;
    };
    apiToken: {
        /**
     ...
     */
        list: (baseId: IdType, params?: RequestParams) => Promise<ApiTokenListType>;
        /**
     ...
     */
        create: (baseId: IdType, data: ApiTokenReqType, params?: RequestParams) => Promise<ApiTokenType>;
        /**
     ...
     */
        delete: (baseId: IdType, tokenId: string, params?: RequestParams) => Promise<number>;
    };
    storage: {
        /**
        ...
        uploadByUrl: (query: {
             ...
             */
            scope?: "workspacePics" | "profilePics" | "organizationPics";
        }, data: AttachmentReqType[], params?: RequestParams) => Promise<any>;
    };
    notification: {
        /**
         ...
         * @response `200` `object` OK
         */
        poll: (params?: RequestParams) => Promise<object>;
        /**
        ...
        list: (query?: {
            ...
            limit?: number;
            offset?: number;
        }, params?: RequestParams) => Promise<NotificationListType>;
        /**
         ...
         * @response `200` `void` OK
         */
        update: (notificationId: string, data: NotificationUpdateType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        delete: (notificationId: string, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        markAllAsRead: (params?: RequestParams) => Promise<void>;
    };
     ...
     */
        dbDataTableAggregate: (tableId: string, query: {
            /** View ID is required */
            viewId: string;
            /** List of fields to be aggregated */
            aggregation?: object[];
     ...
     */
        create: (tableId: string, data: object | object[], query?: {
            /** View ID */
            viewId?: string;
            before?: string;
            undo?: string;
     ...
     */
        update: (tableId: string, data: object | object[], query?: {
            /** View ID */
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        delete: (tableId: string, data: object | object[], query?: {
            /** View ID */
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        read: (tableId: string, rowId: string, query?: {
            /** View ID */
            viewId?: string;
            /** Which fields to be shown */
            fields?: any[];
     ...
     */
        move: (tableId: string, rowId: string, query?: {
     ...
     */
        nestedList: (tableId: string, columnId: string, rowId: string, query?: {
            /** View ID */
            viewId?: string;
            /** Which fields to be shown */
            fields?: any[];
     ...
     */
        nestedLink: (tableId: string, columnId: string, rowId: string, data: object | object[], query?: {
            /** View ID */
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        nestedUnlink: (tableId: string, columnId: string, rowId: string, data: object | object[], query?: {
            /** View ID */
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        attachmentDownload: (modelId: string, columnId: string, rowId: string, query?: {
            /** URL or Path of the attachment */
            urlOrPath?: string;
        }, params?: RequestParams) => Promise<{
            /** URL to download attachment */
     ...
     */
        nestedListCopyPasteOrDeleteAll: (tableId: string, columnId: string, data: NestedListCopyPasteOrDeleteAllReqType, query?: {
            /** View ID */
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
    };
     ...
     */
        list: (baseId: IdType, params?: RequestParams) => Promise<{
            list?: object[];
        }>;
        /**
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        create: (baseId: IdType, data: object, params?: RequestParams) => Promise<any>;
        /**
         ...
         * @response `200` `object` OK
         */
        read: (extensionId: IdType, params?: RequestParams) => Promise<object>;
        /**
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        update: (extensionId: IdType, data: object, params?: RequestParams) => Promise<any>;
        /**
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        delete: (extensionId: IdType, params?: RequestParams) => Promise<any>;
    };
    jobs: {
        /**
         ...
         */
        listen: (data: object, params?: RequestParams) => Promise<any>;
        /**
    ...
    export: {
         ...
         */
        data: (viewId: IdType, exportAs: "csv", data: object, params?: RequestParams) => Promise<any>;
    };
    ai: {
        /**
         ...
         * @response `200` `BaseUserDeleteRequestV3Type` OK
         */
        schemaCreate: (workspaceId: IdType, data: {
            operation?: string;
            input: any;
        }, params?: RequestParams) => Promise<any>;
        /**
         ...
         * @response `200` `(any)[]` OK
         */
        dataGenerate: (modelId: string, data: {
            rowIds: string[];
            column?: string | {
                title: string;
                prompt_raw: string;
         ...
         * @response `200` `(any)[]` OK
         */
        dataExtract: (modelId: string, data: {
            input: string;
        }, params?: RequestParams) => Promise<any[]>;
    };
    integration: {
         ...
         */
        create: (data: IntegrationReqType, params?: RequestParams) => Promise<IntegrationType>;
        /**
         ...
         * @response `200` `IntegrationType` OK
         */
        read: (integrationId: string, query?: {
            includeConfig?: boolean;
            includeSources?: boolean;
        }, params?: RequestParams) => Promise<IntegrationType>;
        /**
         ...
         * @response `200` `void` OK
         */
        update: (integrationId: string, data: IntegrationReqType, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        delete: (integrationId: string, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        setDefault: (integrationId: string, params?: RequestParams) => Promise<void>;
        /**
         ...
         * @response `200` `void` OK
         */
        store: (integrationId: string, data: {
            op: "list";
            limit: number;
            offset: number;
        } | {
    ...
    integrations: {
         ...
         * @response `200` `object` OK
         */
        list: (params?: RequestParams) => Promise<object>;
        /**
         ...
         * @response `200` `object` OK
         */
        info: (type: string, subType: string, params?: RequestParams) => Promise<object>;
        /**
         ...
         * @response `200` `object` OK
         */
        endpoint: (integrationId: string, endpoint: string, data: object, params?: RequestParams) => Promise<object>;
    };
    action: {
        /**
         ...
         * @response `200` `object` OK
         */
        triggerButton: (tableId: string, fieldId: string, data: {
            customRows?: any[];
            rowIds?: string[];
            customField?: object;
        }, query?: {
    ...
    internal: {
         ...
         */
        postOperation: (workspaceId: string, baseId: string, query: {
            /** Operation to trigger */
            operation: string;
            /** Model ID */
            fk_model_id?: string;
        }, data: Record<string, any>, params?: RequestParams) => Promise<Record<string, any>>;
        /**
         * @description Trigger an internal operation
         *
         * @tags Internal
         ...
         * @response `200` `Record<string, any>` OK
         */
        getOperation: (workspaceId: string, baseId: string, query: {
            /** Operation to trigger */
            operation: string;
            /** Model ID */
            fk_model_id?: string;
        }, params?: RequestParams) => Promise<Record<string, any>>;
    };
}
