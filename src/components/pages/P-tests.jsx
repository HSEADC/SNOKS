    ...
    return (
        <StyledPage>
            <StyledMain className="main">
              <TitleContainter className="M-pages-title" textContent="Тест дня <br>"></TitleContainter>
              <Suspense fallback={
                <Loading className="M-loading">Загрузка...</Loading>
              }>
                <TestsCardPaged className="C-main-Tests-UI" tableName="tests"></TestsCardPaged>
              </Suspense>

              <TestsShare className="W-tests-share"></TestsShare>
            </StyledMain>
            <Footer></Footer>
        </StyledPage>
    );
